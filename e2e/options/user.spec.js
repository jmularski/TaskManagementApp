  ...
  describe('Usage', () => {
    ...
    describe('update', () => {
      ...
      it('should fail when mail is in wrong format', async () => {
        await element(by.id('optionsEmailInput')).replaceText('placeholder_image');
        await element(by.id('optionsNameInput')).replaceText(data.optionsName);
        await element(by.id('optionsUpdateProfile')).tap();
      ...
      it('should fail when name is empty', async () => {
        await element(by.id('optionsEmailInput')).replaceText(data.registerEmail);
      ...
      it('should succeed when everything is ok', async () => {
        ...
        await element(by.id('optionsNameInput')).replaceText(data.optionsName);
        await element(by.id('optionsUpdateProfile')).tap();
        await waitFor(element(by.text('Successful update!'))).toBeVisible().withTimeout(10000);
